  ...
  return {
    client: {
      ...
      emailBody: [
        ...
        `Your invoice and PayNow QR code are below. Please use ${invoiceRef} as your payment reference.`,
      ...
      whatsappBody: `Hi ${firstName}! Your balance of $${due} for ${b.sessionLabel} on ${whenStr} is due. Check your email for the PayNow QR code and invoice. Use ${invoiceRef} as your payment reference, then send your payment screenshot here on WhatsApp at +65 9760 0798 — thank you!`,
    },
    photographer: {
