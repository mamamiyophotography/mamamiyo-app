  ...
  return {
    client: {
      ...
      emailBody: [
        ...
        'Your invoice and PayNow QR code are below.',
      ...
      whatsappBody: `Hi ${firstName}! Your balance of $${due} for ${b.sessionLabel} on ${whenStr} is due. Check your email for the PayNow QR code and invoice, then send your payment screenshot here on WhatsApp at +65 9760 0798 — thank you!`,
    },
    photographer: {
